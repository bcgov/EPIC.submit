...
export const RadioOptions = Object.freeze({
  YES: {
    label:
      "Yes, the holder passed the Independent Environmental Monitor Terms of Engagement Review",
    value: "yes",
  },
  NO: {
    label:
      "No, the holder failed the Independent Environmental Monitor Terms of Engagement Review",
    value: "no",
  },
  YES_DEFAULT: {
...
export const iemReviewSchema = yup.lazy((value) => {
