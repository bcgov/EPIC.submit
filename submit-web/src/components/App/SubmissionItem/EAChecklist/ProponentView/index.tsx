...
import {
  SubmissionItemStatus, SUBMISSION_ITEM_STATUS,
  SUBMISSION_TYPE
...
import { EAChecklistGuidelines } from "../EAChecklistGuidelines";
import {
  EarlyEngagementChecklistForm,
  earlyEngagementChecklistSchema
} from "../constants";

export const EarlyEngagementChecklistProponentView = () => {
  const {
  ...
  const methods = useForm<EarlyEngagementChecklistForm>({
    resolver: yupResolver(earlyEngagementChecklistSchema),
    mode: "onSubmit",
    defaultValues: {
  ...
  const handleCompleteForm = (formData: EarlyEngagementChecklistForm) => {
  ...
  const saveSubmission = async (
    _formData: EarlyEngagementChecklistForm,
