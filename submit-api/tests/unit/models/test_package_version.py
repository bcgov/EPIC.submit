"""Test PackageVersion model ORM methods."""
...
def test_get_by_id(session):
    """Returns the package version matching the given id."""
...
def test_get_all_by_original_package_id(session):
    """Returns all versions for the given original package id, newest first."""
    package = factory_package_model()
