...
from submit_api.utils.constants import MANAGEMENT_PLAN_RESUBMISSION_INVITATION_EMAIL_TEMPLATE


class ResubmissionEmailService:
    """Handles sending email notifications for resubmission invitations."""

    @classmethod
    def prepare_resubmission_invitation_email(cls, package: PackageModel) -> EmailDetails:
        """Prepare email details for resubmission invitation."""
